...
//the logic to control the gripper end effector tool.
//pickPoseOffset :궤적이 물체가 충돌할 가능성을 피하기 위해 약간 떠 있다
public class TrajectoryPlanner : MonoBehaviour
{
    ...
    NiryoMoveitJointsMsg CurrentJointConfig() //assign the request.joints_input instead of assigning the values individually.
    {
